...
$.extend($.fn, {
	...
	validate: function( options ) {
		...
		if ( validator.settings.onsubmit ) {
			...
			// when a subfishandler is used, capture the submitting button
			if (validator.settings.subfishandler) {
			...
			this.submit( function( event ) {
				...
				function handle() {
					if ( validator.settings.subfishandler ) {
						...
						validator.settings.subfishandler.call( validator, validator.currentForm );
						if (validator.submitButton) {
